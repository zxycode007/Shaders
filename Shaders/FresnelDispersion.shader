...
{
    Properties {
        fresnelPower("fresnelPower",Range(0.1,3))=0
        fresnelScale("fresnelScale",Range(0.1,3))=0
        fresnelBias("fresnelBias",Range(0.1,3))=0
        _r("r",Range(0,1))=0
        _g("g",Range(0,1))=0
        _b("b",Range(0,1))=0
    ...
    SubShader
    {
        ...
        //     color reflectionfactor=fresnelBias+fresnelScale*pow(1.0f+dot(normalize(-worldViewDir),i.normal),fresnelPower);
            ...
            // half4 skyData = texCUBE(_CubeMap, R);
             //反射颜色
			 ...
			 //refractedColor.r=DecodeHDR (texCUBE(_CubeMap, Tred),unity_SpecCube0_HDR).r;
    //         refractedColor.g=DecodeHDR (texCUBE(_CubeMap, Tgreen),unity_SpecCube0_HDR).g;
    //         refractedColor.b=DecodeHDR (texCUBE(_CubeMap, Tblue),unity_SpecCube0_HDR).b;
